...
-- })
--
-- @param [ t y p e = n u m b e r ] base_delay The original, minimum delay for the first
-- reconnection attempt. Futher attempts will grow exponentially from this
-- delay.
-- @param [ t y p e = n u m b e r ] max_delay The maximum allowed delay for a reconnection
-- attempt.
