...
-- }
--
-- @param [ t y p e = t a b l e ] opts Options for the created client.
...
-- @param [ t y p e = n u m b e r ] timeout Value in milliseconds (for connect/read/write).
-- @treturn boolean `ok`: `true` if success, `nil` if failure.
-- @treturn string `err`: String describing the error if failure.
...
-- @param [ t y p e = n u m b e r ] timeout (optional) Value in milliseconds specifying the
-- maximal idle timeout.
-- @param [ t y p e = n u m b e r ] size (optional) Maximal number of connections allowed in
...
-- @param [ t y p e = s t r i n g ] keyspace Name of the desired keyspace.
-- @treturn boolean `ok`: `true` if success, `nil` if failure.
-- @treturn string `err`: String describing the error if failure.
...
-- print(#rows) -- 1
--
-- @param [ t y p e = s t r i n g ] query CQL query to prepare.
...
--
-- @param [ t y p e = s t r i n g ] query CQL query to execute.
-- @param [ t y p e = t a b l e ] args (optional) Arguments to bind to the query.
-- @param [ t y p e = t a b l e ] options (optional) Options from `query_options`
-- for this query.
-- @treturn table `res`: Table holding the query result if success, `nil` if failure.
-- @treturn string `err`: String describing the error if failure.
-- @treturn number `cql_err`: If a server-side error occurred, the CQL error code.
...
-- }))
--
-- @param [ t y p e = t a b l e ] queries Array of CQL queries to execute as a batch.
-- @param [ t y p e = t a b l e ] options (optional) Options from `query_options`
-- for this query.
-- @treturn table `res`: Table holding the query result if success, `nil` if failure.
-- @treturn string `err`: String describing the error if failure.
...
--
-- @param [ t y p e = s t r i n g ] tracing_id The query's tracing is as returned in the
...
function _Host:get_trace(tracing_id)
    ...
    elseif #rows == 0 then return nil, 'no trace with id: ' .. tracing_id
    end
